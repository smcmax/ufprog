...
#define FTDI_VENDOR_CMD_OUT_REQTYPE	((uint8_t)LIBUSB_REQUEST_TYPE_VENDOR | \
					 (uint8_t)LIBUSB_RECIPIENT_DEVICE | (uint8_t)LIBUSB_ENDPOINT_OUT)
#define FTDI_VENDOR_CMD_IN_REQTYPE	((uint8_t)LIBUSB_REQUEST_TYPE_VENDOR | \
					 (uint8_t)LIBUSB_RECIPIENT_DEVICE | (uint8_t)LIBUSB_ENDPOINT_IN)
